...
type Querier interface {
	...
	GetAttendance(ctx context.Context, arg GetAttendanceParams) (GetAttendanceRow, error)
	GetAttendances(ctx context.Context, arg GetAttendancesParams) ([]GetAttendancesRow, error)
